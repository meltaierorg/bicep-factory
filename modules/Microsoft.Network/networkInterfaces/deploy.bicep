...
resource asg 'Microsoft.Network/applicationSecurityGroups@2023-04-01' = if(deployASG){
  name: ASGName
  location: location
  tags: tags
  properties: {}
  ...
  properties: {
    ...
    ipConfigurations: [for (ipConfiguration, index) in ipConfigurations: {
      ...
      properties: {
        ...
        applicationSecurityGroups: deployASG ? var_applicationSecurityGroups : null
...
var var_applicationSecurityGroups = [
  {
  id: asg.id 
